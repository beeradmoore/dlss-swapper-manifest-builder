...
internal class FidelityFX2_Loader_DX12_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.FidelityFX_SDK2_Loader_DX12;

    public override string NamePath => "fidelityfx_sdk2_loader_dx12";

    public override string ExpectedDLLName => "amd_fidelityfx_loader_dx12.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "FFXDLL_LOADER_VERSION_API AMD FidelityFX Loader Library",
        "AMD FidelityFX (DirectX) Loader Library",
    };
    ...
    public FidelityFX2_Loader_DX12_Processor(List<DLLRecord> manifestDllRecords) : base(manifestDllRecords)
    {
    }
}
