...
internal class FidelityFX2_RadianceCache_DX12_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.FidelityFX_SDK2_RadianceCache_DX12;

    public override string NamePath => "fidelityfx_sdk2_radiancecache_dx12";

    public override string ExpectedDLLName => "amd_fidelityfx_radiancecache_dx12.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "AMD FidelityFX (DirectX) Radiance Cache Library",
    };
    ...
    public FidelityFX2_RadianceCache_DX12_Processor(List<DLLRecord> manifestDllRecords) : base(manifestDllRecords)
    {
    }
}
