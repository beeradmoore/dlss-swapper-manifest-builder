...
internal class Streamline_Interposer_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.Streamline_Interposer;

    public override string NamePath => "sl_interposer";

    public override string ExpectedDLLName => "sl.interposer.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "SL.INTERPOSER MODULE - PRODUCTION",
        "SL.INTERPOSER MODULE - NOT FOR PRODUCTION",
    };
    ...
    public Streamline_Interposer_Processor(List<DLLRecord> manifestDllRecords) : base(manifestDllRecords)
    {
    }
}