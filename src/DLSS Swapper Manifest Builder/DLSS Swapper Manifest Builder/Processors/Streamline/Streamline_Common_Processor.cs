...
internal class Streamline_Common_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.Streamline_Common;

    public override string NamePath => "sl_common";

    public override string ExpectedDLLName => "sl.common.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "SL.COMMON PLUGIN - PRODUCTION",
        "SL.COMMON PLUGIN - NOT FOR PRODUCTION",
    };
    ...
    public Streamline_Common_Processor(List<DLLRecord> manifestDllRecords) : base(manifestDllRecords)
    {
    }
}