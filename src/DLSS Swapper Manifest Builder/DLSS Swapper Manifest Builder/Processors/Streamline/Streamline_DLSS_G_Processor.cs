...
internal class Streamline_DLSS_G_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.Streamline_DLSS_G;

    public override string NamePath => "sl_dlss_g";

    public override string ExpectedDLLName => "sl.dlss_g.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "SL.DLSS_G PLUGIN - PRODUCTION",
        "SL.DLSS_G PLUGIN - NOT FOR PRODUCTION",
    };
