...
internal class Streamline_PCL_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.Streamline_PCL;

    public override string NamePath => "sl_pcl";

    public override string ExpectedDLLName => "sl.pcl.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "SL.PCL PLUGIN - PRODUCTION",
        "SL.PCL PLUGIN - NOT FOR PRODUCTION",
    };
    ...
    public Streamline_PCL_Processor(List<DLLRecord> manifestDllRecords) : base(manifestDllRecords)
    {
    }
}