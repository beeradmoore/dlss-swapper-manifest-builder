...
internal class Streamline_NvPerf_Processor : DLLProcessor
{
    public override GameAssetType GameAssetType => GameAssetType.Streamline_NvPerf;

    public override string NamePath => "sl_nvperf";

    public override string ExpectedDLLName => "sl.nvperf.dll";

    public override string[] ValidFileDescriptions => new string[]
    {
        "SL.NVPERF PLUGIN - PRODUCTION",
        "SL.NVPERF PLUGIN - NOT FOR PRODUCTION",
    };
